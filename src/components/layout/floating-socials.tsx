    ...
    <>
      ...
      >
        ...
        >
          ...
          <span className="absolute h-0.5 w-5 rounded-full bg-current transition-colors" />
          <span className="absolute h-0.5 w-5 rounded-full bg-current transition-colors rotate-90" />
        </motion.span>
      </motion.button>
    </>
  );
